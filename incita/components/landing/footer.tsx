  ...
  return (
    <footer className="w-full bg-[#0d3b49] py-12 px-4 text-center">
      <div className="container mx-auto max-w-5xl">
        <h2 className="text-white font-medium font-semibold mb-2 text-[40px]">Comece a explorar nossa plataforma hoje mesmo</h2>
        <p className="text-white mb-6 px-8 text-[30px]">
