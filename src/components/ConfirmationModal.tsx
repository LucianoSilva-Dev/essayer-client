...
export function ConfirmationModal({ 
  ...
  const iconColor = isDanger ? 'text-red-600' : 'text-[#075F70]'
  const iconBg = isDanger ? 'bg-red-50 border-red-100' : 'bg-[#075F70]/10 border-[#075F70]/20'
  const buttonBg = isDanger ? 'bg-red-600 hover:bg-red-700' : 'bg-[#075F70] hover:bg-[#064e5c]'
        ...
        <div className="flex flex-col md:flex-row items-start gap-6">
          ...
          <div className="flex-1 w-full flex flex-col justify-between">
            <div className="space-y-3 mb-8">
              <h3 className="text-2xl font-semibold text-[#3C3C3C]">{title}</h3>
