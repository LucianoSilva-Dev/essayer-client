          ...
          {temEnvios && isSelected ? (
             <div className="flex items-center gap-1"> {/* Simplified avatar section */}
                <div className="flex -space-x-2 overflow-hidden">
                    ...
                    <div className="inline-block h-8 w-8 rounded-full ring-2 ring-white bg-gray-400 flex items-center justify-center text-xs text-white">A1</div>
                    <div className="inline-block h-8 w-8 rounded-full ring-2 ring-white bg-gray-400 flex items-center justify-center text-xs text-white">A2</div>
                    <div className="inline-block h-8 w-8 rounded-full ring-2 ring-white bg-gray-400 flex items-center justify-center text-xs text-white">A3</div>
                </div>
                 {alunosExtras > 0 && (
