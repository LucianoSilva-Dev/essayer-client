  ...
  return (
    <div className="relative w-full h-full min-h-[280px] z-0 cursor-pointer group/card">
      ...
      <div className="relative w-full h-full">
        ...
        <div 
          className="absolute w-[900px] h-[400px] left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 transition-all duration-300 group-hover/card/card:scale-105 group-hover/card:opacity-70"
          style={{
