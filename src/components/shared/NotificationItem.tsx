    ...
    switch (notification.tipoNotificacao) {
      ...
      case TiposNotificacao.NovaTarefa:
        return {
          ...
          link: `/fazer_tarefa/${n.tarefaId}` // Leva direto para o editor/visualização da tarefa
        };
      ...
      case TiposNotificacao.TarefaFechada:
        return {
          ...
          link: n.tarefaId ? `/fazer_tarefa/${n.tarefaId}` : '#'
        };
      ...
      case TiposNotificacao.TarefaEnviada:
        return {
          ...
          link: `/fazer_tarefa/${n.tarefaId}/revisar`
        };
