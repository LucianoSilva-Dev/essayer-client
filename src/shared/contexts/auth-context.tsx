...
import { getMe, logout as apiLogout } from '../../lib/apiCalls/auth' // Importa as novas funções
import apiClient from '../../lib/http/api-client' // Importa o apiClient para limpar o cache
import { UserLoginBody, UserLoginResponse } from '@/lib/apiCalls/auth/types'
