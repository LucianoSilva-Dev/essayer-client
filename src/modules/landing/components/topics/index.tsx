...
import { CardIcon } from "../card/components/icon"
import { CardTitle } from "../card/components/title"
import { CardDescription } from "../card/components/description"
import { Scale, BookOpen, HeartPulse, Leaf, Brain, Palette, Cpu, BarChart3} from "lucide-react"
import { useState, useRef, useCallback } from "react"
import type { Swiper as SwiperType } from "swiper"
import { motion, useInView } from "framer-motion"
import Link from "next/link"
import { TagList } from "@/modules/landing/components/card/components/tag-list"
import { Tag } from "../card/components/tag"
...
const mainTopics: Topic[] = [
  {
    ...
    icon: <Leaf className="h-6 w-6 text-brand-teal-tertiary" />,
    iconBg: "bg-[#e8f1f1]",
  ...
  },
  {
    ...
    icon: <Brain className="h-6 w-6 text-brand-teal-tertiary" />,
    iconBg: "bg-[#e8f1f1]",
  ...
  },
  {
    ...
    icon: <HeartPulse className="h-6 w-6 text-brand-teal-tertiary" />,
    iconBg: "bg-[#e8f1f1]",
  ...
  },
  {
    ...
    icon: <Palette className="h-6 w-6 text-brand-teal-tertiary" />,
    iconBg: "bg-[#e8f1f1]",
  ...
  },
  {
    ...
    icon: <Scale className="h-6 w-6 text-brand-teal-tertiary" />,
    iconBg: "bg-[#e8f1f1]",
  ...
  },
  {
    ...
    icon: <BookOpen className="h-6 w-6 text-brand-teal-tertiary" />,
    iconBg: "bg-[#e8f1f1]",
  ...
  },
  {
    ...
    icon: <Cpu className="h-6 w-6 text-brand-teal-tertiary" />,
    iconBg: "bg-[#e8f1f1]",
  ...
  },
  {
    ...
    icon: <BarChart3 className="h-6 w-6 text-brand-teal-tertiary" />,
    iconBg: "bg-[#e8f1f1]",
