  ...
  return (
    <footer className="w-full bg-[#173843] py-10 px-4 text-center">
      <div className="container mx-auto max-w-4xl">
        <h2 className="text-white font-medium text-semibold mb-2 text-[35px]">Comece a explorar nossa plataforma hoje mesmo</h2>
        <p className="text-white mb-6 px-8 text-[25px]">
          Você tem a ideia. <br/>
          Nós temos os argumentos.<br/>
          Bora fazer essa redação brilhar?
        </p>
        <Link
          href="/register"
