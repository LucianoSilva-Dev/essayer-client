      ...
      <div>
        ...
        <div className="flex flex-wrap gap-2 md:gap-3">
          {eixosSelecionados.map((eixo, i) => (
            <div
              key={i}
              className="bg-white pl-1.5 md:pl-2 pr-3 md:pr-4 py-1.5 md:py-2 rounded-full flex items-center gap-2 shadow-sm border border-gray-100 shrink-0"
            >
              <div className="bg-brand-teal-secondary w-6 h-6 md:w-7 md:h-7 rounded-full flex items-center justify-center shrink-0">
                <Image
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-2 md:gap-3">
            {recortesSelecionados.map((recorte, index) => (
              <div
                key={index}
                className="flex items-center bg-[#DCDCDD] rounded-[40px] px-3 md:px-4 py-1.5 md:py-2 shrink-0"
              >
                <span
