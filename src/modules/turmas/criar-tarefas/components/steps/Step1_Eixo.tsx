...
const descricoesEixos: Record<string, string> = {
  ...
  "Ciência e Tecnologia":
    "Impactos da inovação, ética digital e avanços científicos.",
  "Cultura e Artes":
    "Identidade, patrimônio histórico e manifestações artísticas.",
  ...
  "Questões Sociais":
    "Desigualdade, minorias e desafios da convivência coletiva.",
      ...
      <div className="flex flex-col gap-6 order-2 lg:order-1">
        ...
        <div className="bg-[#F8FAFC] border-l-4 border-[#075F70] p-6 rounded-r-xl shadow-sm space-y-3">
          ...
          <p className="text-gray-600 text-[15px] leading-relaxed">
            A escolha do eixo temático é fundamental para direcionar o
            repertório sociocultural dos alunos. Ao selecionar um eixo, você
            define a "lente" através da qual o problema será analisado.
          </p>
        </div>
            ...
            return (
              ...
              >
                ...
                <div className="flex flex-col flex-1 min-w-0">
                  ...
                  >
                    {descricoesEixos[eixo.nome] ||
                      "Descrição do eixo temático indisponível."}
                  </p>
                </div>
