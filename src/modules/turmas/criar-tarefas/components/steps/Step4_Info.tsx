...
function TimerWidget({ value, onChange }: { value: number, onChange: (v: number) => void }) {
  ...
  return (
    <div className="bg-white rounded-[30px] p-8 shadow-lg border border-gray-100 flex flex-col items-center justify-center gap-6 relative overflow-hidden w-full h-[320px] group hover:border-brand-teal-dark/30 transition-all duration-300">
        
        {/* Cabeçalho do Card */}
        <div className="flex items-center gap-2 text-gray-400 group-hover:text-brand-teal-dark transition-colors mb-2">
            <Hourglass size={24} />
        ...
        <div className="flex items-center justify-between w-full px-4 xl:px-8">
            ...
            <button 
                ...
                className={cn(
                    ...
                    value <= MIN 
                        ...
                        : "border-gray-200 text-gray-400 hover:border-brand-teal-dark hover:text-brand-teal-dark hover:bg-brand-teal-dark/5 active:scale-95"
                )}
            >
                <Minus size={28} />
            </button>
            ...
            <div className="flex flex-col items-center">
                <span className="font-montserrat font-bold text-[64px] text-neutral-dark leading-none tabular-nums">
                    {value}
                </span>
                <span className="text-sm font-bold text-brand-teal-dark uppercase tracking-widest mt-2 bg-teal-50 px-4 py-1.5 rounded-full">
                    Minutos
                </span>
        ...
        <div className="w-full max-w-[200px] h-1.5 bg-gray-100 rounded-full mt-4 overflow-hidden">
            <div 
                className="h-full bg-brand-teal-dark transition-all duration-500 ease-out rounded-full"
  ...
  return (
    <div className="w-full max-w-6xl mx-auto pb-20 flex flex-col gap-12 animate-in fade-in slide-in-from-right-8 duration-500 px-4">
      ...
      <div className="text-center space-y-3 mb-4">
         <h2 className="font-montserrat font-bold text-[35px] text-neutral-dark">
            Detalhes Finais
         </h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-stretch">
          ...
          <div className="flex flex-col gap-4 h-full">
              <div className="flex flex-col gap-2 min-h-[80px]"> {/* Altura mínima para alinhar textos */}
                  <h3 className="font-montserrat font-bold text-2xl text-brand-teal-dark flex items-center gap-2">
          ...
          <div className="flex flex-col gap-4 h-full">
              ...
              <div className="bg-white rounded-[30px] p-6 shadow-lg border border-gray-100 relative group focus-within:border-brand-teal-dark focus-within:ring-4 focus-within:ring-brand-teal-dark/10 transition-all h-[320px]">
                  <textarea
                      ...
                      className={cn(
                          ...
                          "font-montserrat text-base text-neutral-dark leading-relaxed",
                  ...
                  <div className="absolute bottom-6 right-6 pointer-events-none opacity-50 group-focus-within:opacity-100 transition-opacity">
                      <div className="bg-gray-50 px-3 py-1 rounded-full border border-gray-100 text-xs font-bold text-brand-teal-dark flex items-center gap-2">
                          <Info size={12} />
