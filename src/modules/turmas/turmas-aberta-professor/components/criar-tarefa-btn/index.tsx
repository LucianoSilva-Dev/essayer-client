...
const CriarTarefaButton: React.FC<CriarTarefaButtonProps> = ({ turmaId }) => {
  return (
    ...
    >
      <button
        className="cursor-pointer flex items-center gap-2 px-6 py-2.5 rounded-full bg-brand-teal-dark hover:bg-[#064d5c] shadow-md hover:shadow-lg transition-all duration-300 group"
      >
