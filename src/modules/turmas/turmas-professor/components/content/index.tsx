import ListaTurmas from "../lista-turma";
import NovoCriarTurmaCard from "../criar-turma";
import ModernCorrecoesCard from "../correcoes-card";
import NovoEntrarTurmaCard from "../entrar-turma";
