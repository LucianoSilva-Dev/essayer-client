...
import { RedacaoEditorArea } from '../editor-area';
import { RedacaoHeader } from '../header';
import { RedacaoFooter } from '../footer';
import { MotivacionalModal } from '../motivacional-modal';
import { getAtividadeRedacaoDetalhes, enviarRespostaRedacao, iniciarRespostaRedacao } from '@/lib/apiCalls/tarefas';
import { AtividadeRedacaoDetalhada } from '@/lib/apiCalls/turma/types';
import { TextoData } from '../motivacional-card';
import { ConfirmationModal } from '@/shared/components/confirmation-modals/modal-2/ConfirmationModal';
import { toast } from 'react-toastify';
import { createAutoSave } from '@/modules/redacao/editar/helpers/autoSave';
